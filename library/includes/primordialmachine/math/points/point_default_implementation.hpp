...
struct is_point<point<TRAITS>, STRUCT_CONDITION()> : public true_type
{}; // struct is_point

template<typename TRAITS>
struct point<TRAITS, STRUCT_CONDITION()>
{
  ...
  point(ARGUMENT&& argument, ARGUMENTS&&... arguments);
...
#define TYPE point<TRAITS, STRUCT_CONDITION()>
...
TYPE::point(ARGUMENT&& argument, ARGUMENTS&&... arguments)
...
using elementwise_unary_vector_functor =
  elementwise_unary_functor<point<TRAITS>,
                            point<TRAITS>,
...
using elementwise_binary_vector_functor =
  elementwise_binary_functor<point<TRAITS>,
                             point<TRAITS>,
                             point<TRAITS>,
                             TRAITS::number_of_elements,
                             OPERATOR,
